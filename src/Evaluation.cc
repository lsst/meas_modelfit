...
typedef Eigen::Matrix<Pixel,Eigen::Dynamic,Eigen::Dynamic,Eigen::AutoAlign | Eigen::RowMajor> MatrixRM;
...
void Evaluation::update(lsst::ndarray::Array<Pixel const,1,1> const & parameters) {
