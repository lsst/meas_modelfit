...
using PyMixtureUpdateRestriction = py::class_<MixtureUpdateRestriction,
                                              std::shared_ptr<MixtureUpdateRestriction>>;
using PyMixture = py::class_<Mixture, std::shared_ptr<Mixture>,
                             afw::table::io::PersistableFacade<Mixture>, afw::table::io::Persistable>;
...
static PyMixtureComponent declareMixtureComponent(py::module & mod) {
    ...
    cls.def(
        "project",
        (MixtureComponent (MixtureComponent::*)(int) const)&MixtureComponent::project,
        "dim"_a
    );
    cls.def(
        "project",
        (MixtureComponent (MixtureComponent::*)(int, int) const)&MixtureComponent::project,
        "dim1"_a, "dim2"_a
    );
...
static PyMixture declareMixture(py::module & mod) {
    ...
    cls.def(
        "__iter__",
        [](Mixture & self) { return py::make_iterator(self.begin(), self.end()); },
        py::keep_alive<0, 1>()
    );
    cls.def(
        "__getitem__",
    ...
    cls.def(
        "project",
        (std::shared_ptr<Mixture> (Mixture::*)(int) const)&Mixture::project,
        "dim"_a
    );
    cls.def(
        "project",
        (std::shared_ptr<Mixture> (Mixture::*)(int, int) const)&Mixture::project,
        "dim1"_a, "dim2"_a
    );
    ...
    cls.def(
        ...
        [](
            ...
            ndarray::Array<Scalar,1,0> const & array
        ) -> Scalar {
    ...
    cls.def(
        "evaluate",
        (void (Mixture::*)(
            ndarray::Array<Scalar const,2,1> const &,
    ...
    cls.def(
        ...
        (void (Mixture::*)(
            ndarray::Array<Scalar const,2,1> const &,
            ndarray::Array<Scalar const,1,0> const &,
            MixtureUpdateRestriction const & restriction,
            Scalar,
            Scalar
        )) &Mixture::updateEM,
    ...
    cls.def(
        py::init<int, Mixture::ComponentList &, Scalar>(),
        "dim"_a, "components"_a, "df"_a=std::numeric_limits<Scalar>::infinity()
    );
    cls.def(
        "__str__",
        [](Mixture const & self) {
