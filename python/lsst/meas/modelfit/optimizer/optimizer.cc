...
static PyOptimizerObjective declareOptimizerObjective(py::module & mod) {
    ...
    cls.def_static("makeFromLikelihood", &OptimizerObjective::makeFromLikelihood,
                   "likelihood"_a, "prior"_a=nullptr);
    // class is abstract and not subclassable in Python, so we don't wrap the ctor
    cls.def("fillObjectiveValueGrid", &OptimizerObjective::fillObjectiveValueGrid,
            "parameters"_a, "output"_a);
    cls.def("computeResiduals", &OptimizerObjective::computeResiduals,
            "parameters"_a, "residuals"_a);
    cls.def("differentiateResiduals", &OptimizerObjective::differentiateResiduals,
            "parameters"_a, "derivatives"_a);
    cls.def("hasPrior", &OptimizerObjective::hasPrior);
    cls.def("computePrior", &OptimizerObjective::computePrior, "parameters"_a);
    cls.def("differentiatePrior", &OptimizerObjective::differentiatePrior,
            "parameters"_a, "gradient"_a, "hessian"_a);
    return cls;
}
...
static PyOptimizerHistoryRecorder declareOptimizerHistoryRecorder(py::module & mod) {
    ...
    cls.def(py::init<afw::table::Schema &, std::shared_ptr<Model>, bool>(),
            "schema"_a, "model"_a, "doRecordDerivatives"_a);
    cls.def(py::init<afw::table::Schema const &>(), "schema"_a);
    cls.def("apply", &OptimizerHistoryRecorder::apply,
            "outerIterCount"_a, "innerIterCount"_a, "history"_a, "optimizer"_a);
    cls.def(
        "unpackDerivatives",
        (void (OptimizerHistoryRecorder::*)(
            ndarray::Array<Scalar const,1,1> const &,
            ndarray::Array<Scalar,1,1> const &,
            ndarray::Array<Scalar,2,2> const &
        ) const) &OptimizerHistoryRecorder::unpackDerivatives,
    ...
    cls.def("fillObjectiveModelGrid", &OptimizerHistoryRecorder::fillObjectiveModelGrid,
            "record"_a, "parameters"_a, "output"_a);
...
static PyOptimizer declareOptimizer(py::module & mod) {
    ...
    cls.def(
        py::init<std::shared_ptr<Optimizer::Objective const>,
                 ndarray::Array<Scalar const,1,1> const &,
                 Optimizer::Control>(),
    ...
    cls.def(
        "step",
        (bool (Optimizer::*)(Optimizer::HistoryRecorder const &, afw::table::BaseCatalog &)) &Optimizer::step,
        "recorder"_a, "history"_a);
    cls.def("run", (int (Optimizer::*)()) &Optimizer::run);
    cls.def(
        "run",
        (int (Optimizer::*)(Optimizer::HistoryRecorder const &, afw::table::BaseCatalog &)) &Optimizer::run,
        "recorder"_a, "history"_a);
