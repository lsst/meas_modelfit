...
void declareDoubleShapelet(py::module & mod) {
    ...
    clsAlgorithm.def(py::init<Control const &, std::string const &, afw::table::Schema &>(),
...
void declareGeneral(py::module & mod) {
    ...
    clsFitter.def(
        ...
        [](
            ...
            return self.apply(image, moments, noiseSigma);
        },
        "image"_a,
        "moments"_a,
        "noiseSigma"_a=-1
    ...
    clsFitter.def(
        ...
        [](
            ...
            return self.apply(image, initial, noiseSigma);
        },
        "image"_a,
        "initial"_a,
        "noiseSigma"_a=-1
    ...
    clsAlgorithm.attr("N_FLAGS") = py::cast(int(Algorithm::N_FLAGS));
    clsAlgorithm.def(py::init<Control const &, afw::table::Schema &, std::string const &>(),
                     "ctrl"_a, "schema"_a, "prefix"_a);
    clsAlgorithm.def("getKey", &Algorithm::getKey);
    clsAlgorithm.def(
        "measure",
        (void (Algorithm::*)(
            afw::table::SourceRecord &,
            afw::image::Image<double> const &,
            shapelet::MultiShapeletFunction const &
        ) const)&Algorithm::measure,
