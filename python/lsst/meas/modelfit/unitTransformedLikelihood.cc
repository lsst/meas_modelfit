...
PYBIND11_PLUGIN(unitTransformedLikelihood) {
    ...
    clsEpochFootprint.def(
        py::init<afw::detection::Footprint const &,
    ...
    clsUnitTransformedLikelihood.def(
        py::init<std::shared_ptr<Model>,
                 ndarray::Array<Scalar const,1,1> const &,
                 UnitSystem const &,
                 afw::coord::Coord const &,
                 afw::image::Exposure<Pixel> const &,
                 afw::detection::Footprint const &,
                 shapelet::MultiShapeletFunction const &,
    ...
    clsUnitTransformedLikelihood.def(
        py::init<std::shared_ptr<Model>,
                 ...
                 UnitSystem const &,
                 afw::coord::Coord const &,
                 std::vector<std::shared_ptr<EpochFootprint>> const &,
                 UnitTransformedLikelihoodControl const &>(),
