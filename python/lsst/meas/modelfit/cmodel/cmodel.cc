...
static PyCModelResult declareCModelResult(py::module & mod) {
    ...
    cls.def_property_readonly(
        "flags",
        [](CModelResult const & self) { return BitSetView<CModelResult::N_FLAGS>(&self.flags); },
        py::return_value_policy::reference_internal
    );
...
static PyCModelAlgorithm declareCModelAlgorithm(py::module & mod) {
    ...
    cls.def(py::init<std::string const &, CModelControl const &, afw::table::Schema &>(),
            "name"_a, "ctrl"_a, "schema"_a);
    cls.def(py::init<std::string const &, CModelControl const &, afw::table::SchemaMapper &>(),
            "name"_a, "ctrl"_a, "schemaMapper"_a);
    cls.def(py::init<CModelControl const &>(), "ctrl"_a);
    cls.def("getControl", &CModelAlgorithm::getControl);
    cls.def("apply", &CModelAlgorithm::apply,
            "exposure"_a, "psf"_a, "center"_a, "moments"_a,
            "approxFlux"_a=-1, "kronRadius"_a=-1, "footprintArea"_a=-1);
    cls.def("applyForced", &CModelAlgorithm::applyForced,
            "exposure"_a, "psf"_a, "center"_a, "reference"_a, "approxFlux"_a=-1);
    cls.def(
        "measure",
        (void (CModelAlgorithm::*)(
            afw::table::SourceRecord &,
            afw::image::Exposure<Pixel> const &
        ) const) &CModelAlgorithm::measure,
