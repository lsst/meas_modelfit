...
static void declarePrior(py::module & mod) {
    ...
    cls.def("evaluateDerivatives", &Prior::evaluateDerivatives,
            "nonlinear"_a, "amplitudes"_a,
            "nonlinearGradient"_a, "amplitudeGradient"_a,
            "nonlinearHessian"_a, "amplitudeHessian"_a,
            "crossHessian"_a);
    ...
    cls.def("drawAmplitudes", &Prior::drawAmplitudes,
            "gradient"_a, "hessian"_a, "nonlinear"_a, "rng"_a, "amplitudes"_a, "weights"_a,
