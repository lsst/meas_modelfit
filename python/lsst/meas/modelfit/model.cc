...
PYBIND11_PLUGIN(model) {
    ...
    cls.def_static(
        "make",
        (std::shared_ptr<Model> (*)(Model::BasisVector, Model::NameVector const &, Model::CenterEnum))
            &Model::make,
        "basisVector"_a, "prefixes"_a, "center"_a
    );
    cls.def_static(
        "make",
        (std::shared_ptr<Model> (*)(std::shared_ptr<shapelet::MultiShapeletBasis>, Model::CenterEnum))
            &Model::make,
        "basis"_a, "center"_a
    );
    cls.def_static(
    ...
    cls.def(
        "writeEllipses",
        (Model::EllipseVector (Model::*)(
            ndarray::Array<Scalar const,1,1> const &,
            ndarray::Array<Scalar const,1,1> const &
        ) const) &Model::writeEllipses,
        "nonlinear"_a, "fixed"_a
    );
    cls.def(
        "readEllipses",
        (void (Model::*)(
            Model::EllipseVector const &,
            ndarray::Array<Scalar,1,1> const &,
            ndarray::Array<Scalar,1,1> const &
        ) const) &Model::readEllipses,
        "ellipses"_a, "nonlinear"_a, "fixed"_a
    );
    cls.def("transformParameters", &Model::transformParameters,
            "transform"_a, "nonlinear"_a, "amplitudes"_a, "fixed"_a);
