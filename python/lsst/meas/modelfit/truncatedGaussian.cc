...
PYBIND11_PLUGIN(truncatedGaussian) {
    ...
    py::enum_<TruncatedGaussian::SampleStrategy>(cls, "SampleStrategy")
        ...
        .export_values();
    cls.def_static("fromSeriesParameters", &TruncatedGaussian::fromSeriesParameters,
                   "q0"_a, "gradient"_a, "hessian"_a);
    cls.def_static("fromStandardParameters", &TruncatedGaussian::fromStandardParameters,
                   "mean"_a, "covariance"_a);
    cls.def(
        "sample",
        (Sampler (TruncatedGaussian::*)(TruncatedGaussian::SampleStrategy) const) &TruncatedGaussian::sample,
        "strategy"_a
    );
    cls.def(
        "sample",
        (Sampler (TruncatedGaussian::*)(Scalar) const) &TruncatedGaussian::sample,
    ...
    clsSampler.def(py::init<TruncatedGaussian const &, TruncatedGaussian::SampleStrategy>(),
                   "parent"_a, "strategy"_a);
    clsSampler.def(
        "__call__",
        (Scalar (Sampler::*)(
            afw::math::Random &,
            ndarray::Array<Scalar,1,1> const &
        ) const) &Sampler::operator(),
        "rng"_a, "alpha"_a
    );
    clsSampler.def(
        "__call__",
        (void (Sampler::*)(
            afw::math::Random &,
            ndarray::Array<Scalar,2,1> const &,
            ndarray::Array<Scalar,1,1> const &,
            bool
        ) const) &Sampler::operator(),
