...
class BaseMeasureConfig(lsst.pex.config.Config):
    ...
    previous = lsst.pex.config.Field(
        ...
        default=None,
        optional=True,
        doc="The tag of a previous run of a meas_multifit measure task to use as inputs"
    )
...
class BaseMeasureTask(lsst.pipe.base.CmdLineTask):
    ...
    def makeTable(self):
        ...
        sample schema.
        """
        table = lsst.meas.multifit.ModelFitTable.make(self.schema, self.fitter.makeSampleTable(),
