...
#ifndef LSST_MEAS_MODELFIT_MarginalSamplingInterpreter_h_INCLUDED
#define LSST_MEAS_MODELFIT_MarginalSamplingInterpreter_h_INCLUDED
...
#endif // !LSST_MEAS_MODELFIT_MarginalSamplingInterpreter_h_INCLUDED
