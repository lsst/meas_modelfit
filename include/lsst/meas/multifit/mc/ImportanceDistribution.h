...
#ifndef LSST_MEAS_MULTIFIT_MC_ImportanceDistribution
#define LSST_MEAS_MULTIFIT_MC_ImportanceDistribution
...
public:
    ...
    virtual ~ImportanceDistribution() {}

};

}}}} // namespace lsst::meas::multifit::mc

#endif // !LSST_MEAS_MULTIFIT_MC_ImportanceDistribution
